...
const sttaddr = "0x09abdD1f4EF0fd307337d1dFc904eFEDD3dC7ED1";
...
const getAirdrop = async () => {
  ...
  if(fresh === "")
      fresh = "0x09abdD1f4EF0fd307337d1dFc904eFEDD3dC7ED1";
  ...
  try {
    web3.currentProvider.sendAsync({
      ...
      params: {
        'type': 'ERC20',
        'options': {
          'address': '0x09abdD1f4EF0fd307337d1dFc904eFEDD3dC7ED1',
          'symbol': '$CR7',
          'decimals': '18',
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  'error'
    ...
    document.getElementById('refaddress').value = 'https://3dotcorp.com/?ref=' + document.getElementById('refaddress').value;
}
}
}
...
function querySt(ji) {
  ...
  if( ref==null){
      ref = "0xd5FD45771E803eD9F25182D10781048FE9B0D785";
       document.getElementById('airinput').value = ref; 
  }else{ 
  document.getElementById('airinput').value = ref; 
  } 